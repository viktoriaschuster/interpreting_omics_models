...
for hidden_factor in tqdm(hidden_factor_options):
    for lr in lr_options:
        for l1_weight in l1_weight_options:
            ...
            sae_model, loss = train_sae(train_loader, input_size=input_size, hidden_factor=hidden_factor, lr=lr, l1_weight=l1_weight, sparsity_penalty=sparsity_penalty, n_epochs=500, sae_type=sae_type)
...
df_sae_metrics.to_csv('03_results/reports/files/sim_modl1l4_sae-'+sae_type+'2_metrics_spearman.csv', index=False)