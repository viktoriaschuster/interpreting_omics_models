...
for hidden_factor in tqdm(hidden_factor_options):
    for lr in lr_options:
        for k in k_options:
            ...
            sae_model, loss = train_sae(train_loader, input_size=input_size, hidden_factor=hidden_factor, lr=lr, l1_weight=l1_weight, sparsity_penalty=sparsity_penalty, n_epochs=epochs[lr], sae_type='topk', k_latent_percent=k)
