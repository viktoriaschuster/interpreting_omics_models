...
# load data and model
data = md.read('./01_data/mouse_gastrulation.h5mu', backed=False)
model = multiDGD.DGD.load(data=data, save_dir='./03_results/models/', model_name='mouse_gastrulation_l20_h2-3')
...
for scaling_factor in scaling_factors:
    ...
    for l1_weight in l1_weights:
        for learning_rate in lrs:
            ...
            save_name = '03_results/reports/sc_sae_sweep/mousegast_vanilla_{}_{}_{}_losscurves.csv'.format(scaling_factor, l1_weight, learning_rate)
            df.to_csv(save_name)
            # delete everything
            del sae_model
            del optimizer
