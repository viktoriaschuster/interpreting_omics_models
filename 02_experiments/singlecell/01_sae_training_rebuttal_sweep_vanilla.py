...
# load data and model
import os
if not os.path.exists('./01_data/human_bonemarrow.h5ad'):
    try:
        # unzip the data
        print('Unzipping data')
        import zipfile
        with zipfile.ZipFile('./01_data/human_bonemarrow.h5ad.zip', 'r') as zip_ref:
...
for scaling_factor in scaling_factors:
    ...
    for l1_weight in l1_weights:
        for learning_rate in lrs:
            ...
            save_name = '03_results/reports/sc_sae_sweep/vanilla_{}_{}_{}_losscurves.csv'.format(scaling_factor, l1_weight, learning_rate)
            df.to_csv(save_name)
            # delete everything
            del sae_model
            del optimizer
