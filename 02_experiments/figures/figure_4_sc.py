...
axs[0,0].text(-0.3, 1.1, "A", fontsize=16, transform=axs[0,0].transAxes, fontweight='bold')
...
###
i, j = 1, 0
axs[i,j].text(-0.3, 1.1, "B", fontsize=16, transform=axs[i,j].transAxes, fontweight='bold')
#feature = 1238
feature = 1500
...
#plt.tight_layout()
# save
plt.savefig("03_results/figures/sc_reps_all.png", dpi=300, bbox_inches='tight')